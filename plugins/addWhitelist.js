...
*Example:*
${usedPrefix + command} add 9481111111111,12345678901,0
${usedPrefix + command} remove 9481111111111,12345678901,0
`.trim()
    ...
    m.reply(`Succeeded ${type ? 'add' : 'remove'} whitelist ${users.length} users`)
}
